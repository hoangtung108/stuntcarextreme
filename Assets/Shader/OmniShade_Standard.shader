Shader "OmniShade/Standard" {
	Properties {
		...
		[Toggle] _UseAlpha ("Use Alpha Mask", Float) = 0
		...
		[PowerSlider(10)] _SpecularSmoothness ("Specular Smoothness", Range(1, 500)) = 5
		...
		[HDR] _ShadowColor ("Shadow Color", Vector) = (0,0,0,1)
